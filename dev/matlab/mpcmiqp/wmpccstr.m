function [ G, h ] = wmpccstr( m, q, d, n, delta, eta, z0, pw, zlb, zub )
% Define constraints on the optimisation of the performance index for 
% state-space MPC of wind power dispatch with battery energy storage.
% Contraints take the form of G*x <= h, where G is a matrix of constraint
% coefficients, x is the argument vector, and h is a vector of constraint
% thresholds.
